...
def main():
	...
	#pdb.set_trace()
	#g=open(exFn+".E","a")
	g=open("C:/Users/Andre/Downloads/PPUCMUCPTfiltered_feature_bc_matrix14.E","a")
	g.write("\t".join(FR)+"\n")
	...
	g=open("C:/Users/Andre/Downloads/PPUCMUCPTfiltered_feature_bc_matrix14.E","a")
	#g.write("\t".join(FR3)+"\n")
	for j in range(len(barcodes3)):
		ci3=barcodes3[j]
		ti3=meta[j][1] if len(meta)>0 else 3
		#ti3=int(ti3)
		li3=meta[j][2] if len(meta)>0 else 'NA'
		ei3=mat3[j].toarray()[0]
		oi3=[ci3,ti3,li3]+list(ei3)
	...
	g=open("C:/Users/Andre/Downloads/PPUCMUCPTfiltered_feature_bc_matrix14.E","a")
	for k in range(len(barcodes1)):
		ci1=barcodes1[k]
		ti1=meta[k][1] if len(meta)>0 else 1
		#ti1=int(ti1)
		li1=meta[k][2] if len(meta)>0 else 'NA'
		ei1=mat1[k].toarray()[0]
